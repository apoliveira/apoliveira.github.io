...
\section{Teaching}
 $for(teaching)$
 \cvitem{$teaching.date$}{$teaching.description$}
 $endfor$

\section{Research Experience}
 $for(research_experience)$
 \cvitem{}{$research_experience.description$ $sep$, $research_experience.extra$}
 $endfor$

 \section{Conferences}
 $for(conferences)$
\cventry{$conferences.date$}{$conferences.name$}{$conferences.location$}
$endfor$
